...
final class RegistrationContext implements Context, RegisterPresenter, ValidateEmailPresenter
{
    ...
    public function iRegisterWithParameters(TableNode $table)
    {
        ...
        $registerRequest->shortBreakDuration = array_key_exists(4, $userData) ? (int) $userData[4] : null;
        $registerRequest->longBreakDuration = array_key_exists(5, $userData) ? (int) $userData[5] : null;

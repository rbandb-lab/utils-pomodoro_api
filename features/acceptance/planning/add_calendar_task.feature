...
# input of a calendar task
  ...
  @add-calendar-task
  Scenario:
    Given I add a "New Year" task in my calendarTaskList starting at "2021-12-31 23:00:00" and ending at "2022-01-01 00:00:00"
    ...
    And the "calendarTaskList" node should have 1 elements

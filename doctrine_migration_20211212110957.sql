-- Doctrine Migration File Generated on 2021-12-12 11:09:57
...
CREATE TABLE token (id VARCHAR(36) NOT NULL, worker_id VARCHAR(36) DEFAULT NULL, token_string VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL  '--'(DC2Type:datetime_immutable), PRIMARY KEY(id));
